...
export const Checkbox: React.FC<CheckboxProps> = ({
  ...
  return (
    <>
      <div className="group flex w-fit cursor-pointer select-none space-x-2 font-poppinsBold text-white items-center justify-center">
        <div
        ...
        <p
          className="font-poppins text-label-large font-extrabold text-primary"
          onClick={() => setSelected(!selected)}
        >
          {children}
        </p>
